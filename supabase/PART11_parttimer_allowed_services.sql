-- ============================================================
-- Part-timer allowed services
-- Link each part-timer user to the services they are allowed to work on.
-- Safe to run multiple times (IF NOT EXISTS guards + RLS recreate).
-- ============================================================
